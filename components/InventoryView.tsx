...
const InventoryView: React.FC<InventoryViewProps> = ({ products, onAddProduct, onUpdateProduct, onDeleteProductRequest, permissions, onImportProducts }) => {
    ...
    const exportToCSV = () => {
        ...
        const headers = ['sku', 'name', 'category', 'price', 'costPrice', 'pricingType', 'productType', 'description', 'imageUrl'];
        const csvRows = [
            headers.join(','),
            ...products.map(p => {
                const row = [
