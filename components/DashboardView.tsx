...
const DashboardView: React.FC<DashboardViewProps> = ({ sales, products, suppliers, supplierInvoices }) => {
    ...
    const DateButton: React.FC<{ label: string; range: DateRange; activeRange: DateRange; onClick: (range: DateRange) => void }> = ({ label, range, activeRange, onClick }) => (
        <button
