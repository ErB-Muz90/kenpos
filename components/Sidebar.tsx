...
const NAV_ITEMS: { view: View; label: string; icon: React.ReactNode; permission: Permission }[] = [
...
const SidebarContent: React.FC<Omit<SidebarProps, 'isOpen' | 'setIsOpen'>> = ({ currentView, setCurrentView, role, permissions }) => {
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, isOpen, setIsOpen, role, permissions }) => {
